...
function (_React$Component) {
  ...
  _proto.renderSVG = function renderSVG() {
    ...
    if (this.container instanceof Node) {
      var _this$props = this.props,
          ...
          _onInjected = _this$props.onInjected,
      ...
      this.svgWrapper = this.container.appendChild(div.firstChild);
  ...
  _proto.render = function render() {
    var _this$props2 = this.props,
        ...
        rest = _objectWithoutPropertiesLoose(_this$props2, ["evalScripts", "fallback", "loading", "onInjected", "renumerateIRIElements", "src", "svgClassName", "svgStyle"]);
